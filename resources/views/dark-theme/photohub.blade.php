            ...
            <div class="container">
                <div class="div-center">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <!-- Box Comment -->
                            <div class="card card-widget medium-dark-background">
                              <div class="card-header">
                                ...
                                <div class="card-tools">
                                    ...
                                    <a href='{{ route('post.delete', ['id' => $image->id]) }}' onclick='return confirm("Are you sure that you want to delete this post?")'>
                                      <button type="button" class="btn btn-tool text-light" title="delete post">
                              ...
                              <div class="card-body shadow">
                                ...
                                @if($voted == 'true')
                                    <a href='{{ route('image.remove_upvote', ['id' => $image->id]) }}'>
                                        <button type="button" class="btn btn-default btn-sm active_button text-light">
                                            <i class="far fa-arrow-alt-circle-up active_icon text-light"></i>
                                            Vote
                                        </button>
                                    </a>
                                @else 
