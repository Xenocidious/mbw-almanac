...
<body class="transition sidebar-mini layout-fixed">
  ...
  <div class="callout callout-info" id="mapToolbox">
                  ...
                  <script type='text/javascript'>
                    ...
                    function provinceHover(name, action){
                      ...
                      if(action == 'enable'){
                        ...
                        setTimeout(function(){
                            mapToolbox.style.display = "block";
                            title.innerHTML = name;
                            descr.innerHTML = name + '\'s content goes here';

                            onmousemove = function(e){
                              mapToolbox.style.left = e.clientX;
                              mapToolbox.style.transition = '.2s ease-in-ease-out';
                              mapToolbox.style.top = e.clientY+150;
                            }
                        }, 1);
                      }else{
                        mapToolbox.style.display = "none";
